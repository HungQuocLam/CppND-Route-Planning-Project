...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    for (auto each_neighbor : current_node->neighbors) {
        each_neighbor->parent = current_node;
        each_neighbor->g_value = current_node->g_value + current_node->distance(*each_neighbor);
        each_neighbor->h_value = CalculateHValue(each_neighbor);
        open_list.push_back(each_neighbor);
